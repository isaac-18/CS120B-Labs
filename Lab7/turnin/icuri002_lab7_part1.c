/*	
 *	https://drive.google.com/file/d/1HyikAgcuK-BofYZKyypVRBLSccwxago3/view?usp=sharing
 *
 *	Author: icuri002
 *  Partner(s) Name: 
 *	Lab Section: 024
 *	Assignment: Lab #7  Exercise #1
 *	Exercise Description: Increment and decrement w/ button press every 100ms and display
 *
