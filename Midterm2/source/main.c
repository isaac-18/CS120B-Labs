...
typedef enum ping_states { PInit, PingHigh, PingLow } ping_states;
typedef enum detect_eq_states { DEQInit, DEQ_Wait, DEQ_Detected } detect_eq_states;
...
unsigned char pingOut;
unsigned char ampOut;
unsigned char eq_detected;
